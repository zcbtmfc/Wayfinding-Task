...
public static class ConditionModel
{
    ...
    public struct conditionMap
    {
        ...
        public string m_AnimationAgent_A2;
        ...
        public string m_AnimationAgent_B2;
    ...
    public static void Init(int id, string audioAgent_A, string animationAgent_A, string animationAgent_A2, Vector3 positionAgent_A, Quaternion rotationAgent_A, string audioAgent_B, string animationAgent_B, string animationAgent_B2, Vector3 positionAgent_B, Quaternion rotationAgent_B)
    {
        var tmpMap = new conditionMap();
        tmpMap.m_AudioAgent_A = audioAgent_A;
        tmpMap.m_AnimationAgent_A = animationAgent_A;
        tmpMap.m_AnimationAgent_A2 = animationAgent_A2;
        ...
        tmpMap.m_AnimationAgent_B2 = animationAgent_B2;
